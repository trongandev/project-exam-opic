        ...
        levels: [
            {
                level: '1',
                desc: '(Novice High)',
                descArr: ['NL - Novice Low', 'NM - Novice Mid', 'NH - Novice High'],
                claim: '1.000.000đ',
                description: 'Người mới bắt đầu',
                explain: 'Có khả năng giao tiếp cơ bản và sử dụng từ vựng đơn giản.',
                isPopular: false,
            },
            {
                level: '2',
                desc: '(Intermediate Low)',
                descArr: ['IL - Intermediate Low'],
                claim: '1.500.000đ',
                description: 'Trung cấp thấp',
                explain: 'Có khả năng giao tiếp trong các tình huống quen thuộc.',
                isPopular: true,
            },
            {
                level: '3',
                desc: '(Intermediate Mid)',
                descArr: ['IH - Intermediate Mid', 'IH - Intermediate High'],
                claim: '3.000.000đ',
                description: 'Trung cấp',
                explain: 'Có khả năng giao tiếp hiệu quả trong nhiều tình huống.',
                isPopular: true,
            },
            {
                level: '4',
                desc: '(Advanced Low)',
                descArr: ['AL - Advanced Low'],
                claim: '4.000.000đ',
                description: 'Trung cấp cao',
                explain: 'Có khả năng giao tiếp tự tin và linh hoạt.',
                isPopular: false,
            },
            {
                level: '5',
                desc: '(Advanced Mid)',
                descArr: ['AL - Advanced Mid', 'AM - Advanced High'],
                claim: '5.000.000đ',
                description: 'Cao cấp thấp',
                explain: 'Có khả năng giao tiếp trôi chảy và chính xác.',
                isPopular: false,
            },
            { level: '6', desc: '(Superior)', descArr: ['S - Superior'], claim: '6.000.000đ', description: 'Cao cấp', explain: 'Có khả năng giao tiếp tự nhiên và phong phú.', isPopular: false },
        ],
    },
