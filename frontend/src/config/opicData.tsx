...
export const opicInfo = {
    ...
    scoreRange: {
        ...
        levels: [
            { level: "NH (Novice High)", score: "0-2", description: "Người mới bắt đầu" },
            { level: "IL (Intermediate Low)", score: "3-4", description: "Trung cấp thấp" },
            { level: "IM (Intermediate Mid)", score: "5-6", description: "Trung cấp" },
            { level: "IH (Intermediate High)", score: "7-8", description: "Trung cấp cao" },
            { level: "AL (Advanced Low)", score: "9-10", description: "Cao cấp thấp" },
            { level: "AM (Advanced Mid)", score: "11-12", description: "Cao cấp" },
        ],
    },
