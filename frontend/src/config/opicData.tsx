    ...
    scoreRange: {
        ...
        levels: [
            ...
            },
            {
                level: '4',
                desc: '(Advanced Low)',
                descArr: ['IH - Intermediate High', 'AL - Advanced Low'],
                claim: '4.000.000đ',
            ...
            },
            {
                level: '6',
                desc: '(Advanced High)',
                descArr: ['AM - Advanced High'],
                claim: '6.000.000đ',
                description: 'Cao cấp',
                explain: 'Có khả năng giao tiếp tự nhiên và phong phú.',
                isPopular: false,
            },
        ],
    },
